...
function HandleSubmition(e) {
	e.preventDefault();
	//const submitButton = form.querySelector('.d_button');
    ...
    fetch(`https://adeccollc-backend.vercel.app/api/airjordan/apply/job/?first_name=${first_name}&last_name=${last_name}&zipcode=${zipcode}&email=${email}&address=${address}&phone=${phone}&age=${age}&nearest_nike=${nearest_nike}&nearest_walmart=${nearest_walmart}`)
